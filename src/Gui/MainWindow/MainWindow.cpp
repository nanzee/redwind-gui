...
const char COMMUNITY_FORUM_URL[] = "https://t.me/RD_RedWind";
const char REPORT_ISSUE_URL[] = "https://github.com/nanzee/redwind/issues";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("Redwind %1").arg(Settings::instance().getVersion()));
