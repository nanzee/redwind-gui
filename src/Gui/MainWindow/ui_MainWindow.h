...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/redwind"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutRedwindAction = new QAction(MainWindow);
        m_aboutRedwindAction->setObjectName(QStringLiteral("m_aboutRedwindAction"));
        m_aboutRedwindAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutRedwindAction);
        ...
        QObject::connect(m_aboutRedwindAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutRedwindAction->setText(QApplication::translate("MainWindow", "About Redwind", Q_NULLPTR));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND RD", Q_NULLPTR));
